export class CasePrecheckLang{
  ...
  alertThere_is_no_record_of_this_patient = ['There is no record of this patient','Không có dữ liệu về người này'];
  txtPlaceholder = ['Enter resident ID','Nhập ID để tìm'];
}